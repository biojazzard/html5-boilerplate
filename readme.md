...
Clone the git repo - `git clone git://github.com/biojazzard/html5-boilerplate.git` - or [download it](https://biojazzard@github.com/biojazzard/html5-boilerplate.git)
